                          ...
                          children: [
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  if ((_model.uploadedLocalFile_avatarLocalUpload
                                    ...
                                    {
                                      safeSetState(() => _model
                                              .isDataUploading_avatarSupabaseLocalUpload =
                                          true);
                                      var selectedUploadedFiles =
                                          <FFUploadedFile>[];
                                      ...
                                      try {
                                        ...
                                        selectedMedia =
                                          ...
                                          selectedUploadedFiles,
                                          storageFolderPath: 'fotos_perfis',
                                        );
                                        downloadUrls =
                                        ...
                                        _model.isDataUploading_avatarSupabaseLocalUpload =
                                            false;
                                      }
                                      if (selectedUploadedFiles.length ==
                                          ...
                                          downloadUrls.length ==
                                              selectedMedia.length) {
                                        safeSetState(() {
                                          _model.uploadedLocalFile_avatarSupabaseLocalUpload =
                                              selectedUploadedFiles.first;
                                          _model.uploadedFileUrl_avatarSupabaseLocalUpload =
                                              downloadUrls.first;
                                        });
                                      } else {
                                        safeSetState(() {});
                                    ...
                                    await UsuarioTable().update(
                                      data: {
                                        'foto_perfil': _model
                                            .uploadedFileUrl_avatarSupabaseLocalUpload,
                                      },
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                ...
                                context.goNamedAuth(PaginaLoginWidget.routeName,
                                    context.mounted);
                              },
                              text: 'Logout',
                              options: FFButtonOptions(
