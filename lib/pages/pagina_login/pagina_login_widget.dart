...
class PaginaLoginWidget extends StatefulWidget {
  const PaginaLoginWidget({super.key});

  static String routeName = 'PaginaLogin';
  static String routePath = '/paginaLogin';

  @override
  State<PaginaLoginWidget> createState() => _PaginaLoginWidgetState();
}
